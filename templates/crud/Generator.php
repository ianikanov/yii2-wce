...
namespace ianikanov\wce\templates\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'This generator generates a widget-controller and views that implement CRUD (Create, Read, Update, Delete)
            operations for the specified data model that can be embedded into any other view.';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['controllerClass'], 'match', 'pattern' => '/ControllerWidget$/', 'message' => 'Controller class name must be suffixed with "ControllerWidget".'],
            [['controllerClass'], 'match', 'pattern' => '/(^|\\\\)[A-Z][^\\\\]+ControllerWidget$/', 'message' => 'Controller class name must start with an uppercase letter.'],
    ...
    {
        return array_merge(parent::stickyAttributes(), ['indexWidgetType']);
    }
    ...
    public function getControllerID()
    {
        ...
        $class = substr(substr($this->controllerClass, $pos + 1), 0, -16);//strip ControllerWidget
